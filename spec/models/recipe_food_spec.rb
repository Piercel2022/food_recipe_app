...
RSpec.describe RecipeFood, type: :model do
  before(:each) do
    @user = User.create(name: 'Onomeh', email: 'onwuanibeonome@gmail.com', password: '123456')
    @food = Food.create(name: 'Burger', measuring_unit: 'gram', price: 230, quantity: 4, user_id: @user.id)
    @recipe = Recipe.create(name: 'Fried Rice', description: 'To made a delicious meal ...',
                            preparation_time: 10, cooking_time: 20, user_id: @user.id, public: false)
