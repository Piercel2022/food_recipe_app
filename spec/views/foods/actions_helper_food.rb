module ActionsHelperFood
  def sign_up
    ...
    fill_in 'user_name', with: 'Pierre', id: 'user_name'
    fill_in 'user_email', with: 'piercel.coder2022@gmail.com', id: 'user_email'
  ...
  def add_food
    ...
    fill_in 'food_measuring_unit', with: 'kg', id: 'food_measuring_unit'
